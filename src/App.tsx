        ...
        return (
          <Suspense
            fallback={
              <LazyScreenFallback
                label="Module voix"
                hint="Chargement du pipeline audio local…"
              />
            }
          >
        ...
        return (
          <Suspense
            fallback={
              <LazyScreenFallback
                label="Réglages"
                hint="Chargement des panneaux avancés…"
              />
            }
          >
        ...
        return (
          <Suspense
            fallback={
              <LazyScreenFallback
                label="Traçage"
                hint="Chargement du module de reasoning…"
              />
            }
          >
        ...
        return (
          <Suspense
            fallback={
              <LazyScreenFallback
                label="Capacités"
                hint="Chargement des capacités locales…"
              />
            }
          >
      ...
      <ResponsivePane variant="primary">
        <div
          style={{
            ...
            gap: 12,
            background: active === "Home" ? "transparent" : palette.surface,
            border: active === "Home" ? "none" : `1px solid ${palette.border}`,
            borderRadius: 14,
            padding: active === "Home" ? 0 : 12,
