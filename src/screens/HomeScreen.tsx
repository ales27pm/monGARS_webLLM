...
const HomeScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
  const { messages, sendMessage, isGenerating, config } =
  ...
  const modelLabel = useMemo(
    () => getModelShortLabel(config.modelId) || config.modelId,
    [config.modelId],
  );
      ...
      <View style={styles.hero}>
        <View style={styles.heroHeaderRow}>
          <View>
            ...
            <Text style={styles.modelHint}>Modèle actif : {modelLabel}</Text>
          </View>
          <View
